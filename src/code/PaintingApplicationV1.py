...
from PyQt5.QtWidgets import QApplication, QMainWindow,QAction, QFileDialog, QMessageBox, QColorDialog, QDialog, QTextEdit
...
class PaintingApplication(QMainWindow): # documentation https://doc.qt.io/qt-5/qmainwindow.html
    ...
    def __init__(self):
        ...
        mainMenu.setNativeMenuBar(False) # it is needed for MacOS, see https://stackoverflow.com/a/31028590
    ...
    def brushColor(self):
        """Opens a colour dialog and assigns the selected colour to the brush colour"""
    ...
    def exit(self):
        ...
        buttonReply = QMessageBox.question(self, 'Exit Confirmation', "Exit Paint?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
